...
let products = [
    ...
    {
        name: "Nike WMNS Air Force 1 Low Valentine",
        tag: "NikeWMNSAirForce1LowValentine",
        price: 9207.00,
        inCart: 0
    }, 
...
<div class="col bg-white text-dark"> 
  ...
  <div class="product">
     ...
     <div class="col bg-white text-dark">
        <div class="quantity">
            <button type="button" class="btn btn-dark"><i class="fa-sharp fa-solid fa-plus"></i></button>

        ${item.inCart} 
        <button type="button" class="btn btn-dark" ><i class="fa-sharp fa-solid fa-minus"></i></button>
         </div>
    </div>   
